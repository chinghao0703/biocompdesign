...
""" Factor Graph classes forming structure for PGMs
    Basic structure is based on the MATLAB code by J. Pacheco
    Central difference: nbrs stored as references, not ids
        (makes message propagation easier)
    and the BRML toolbox from David Barber:
    http://www.cs.ucl.ac.uk/staff/d.barber/brml/
    and Ryan Lester's depository https://github.com/rdlester/pyfac
